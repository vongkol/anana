...
class PackageController extends Controller
{
    ...
    public function save(Request $r)
    {
        ...
        if($i)
        {
            ...
            return redirect('/anana-admin/package/create');
        }
        else
        {
            $r->session()->flash('sms1', 'Fail to create a new package. Please check your input again!');
            return redirect('/anana-admin/package/create')->withInput();
        }
    }
    public function update(Request $r)
    {
        ...
        if($i)
        {
            ...
            return redirect('/anana-admin/package/edit/'.$r->id);
        }
        else
        {
    ...
    public function delete(Request $r)
    {
        ...
        return redirect('anana-admin/package');
    }
