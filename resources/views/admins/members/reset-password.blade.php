...
<form action="{{url('analee-admin/member/change-password')}}" class="form-horizontal" method="POST">
    {{csrf_field()}}
    ...
    <div class="row">
        <div class="col-sm-7">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="password" class="form-control" required autofocus name="new_password" >
                </div>
            </div>
            <div class="form-group">
                <label for="confirm_password" class="col-sm-3 control-label">Confirm Password <span class="text-danger">*</span></label>
                <div class="col-sm-9">
                    <input type="password" class="form-control" required autofocus name="confirm_password" >
                </div>
            </div>
