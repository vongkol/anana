...
<div class="container" style="margin-top:150px">
    <h3>Transfer To Any Register Wallet <a href="{{url('member/earning')}}" class="btn btn-success btn-sm">  <i class="fa fa-arrow-left" aria-hidden="true"></i>  Back</a></h3>
    <p></p>
    <div class="row">
        <div class="col-sm-9">
            @if(Session::has('sms'))
            ...
            <form action="{{url('member/transfer/anyregister/save')}}" method="POST">
                ...
                <div class="form-group row">
                    <label for="" class="control-label col-sm-3">Register Wallet</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" readonly value="{{$member->register_wallet}}">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="" class="control-label col-sm-3">To Account</label>
                    <div class="col-sm-8">
