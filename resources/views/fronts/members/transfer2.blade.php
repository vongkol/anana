...
<div class="container" style="margin-top:150px">
    <h3>Transfer To Any Wallet <a href="{{url('member/earning')}}" class="btn btn-success btn-sm">  <i class="fa fa-arrow-left" aria-hidden="true"></i>  Back</a></h3>
    <p></p>
    <div class="row">
        <div class="col-sm-9">
            @if(Session::has('sms'))
            ...
            @endif
            <form action="{{url('member/transfer/anywallet/save')}}" method="POST">
                {{csrf_field()}}
